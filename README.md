...
I am a passionate **5th Semester B.Tech Computer Science & Engineering** student who loves transforming complex logic into elegant, clean code. Currently focusing on building robust backend systems, dynamic full-stack applications, and exploring the power of Machine Learning.

- 🎓 **Education:** Pursuing B.Tech in CSE 
- 💡 **Current Focus:** Deep diving into Data Structures & Algorithms (DSA) and improving my skills, focusing to level up and be the best version of myself.
- 🌱 **Learning & Improving:** Scaling Node.js backend performance, Next.js optimization, and advanced SQL tuning
- 🧩 **Mindset:** Obsessed with clean code architecture, meticulous debugging, and building reusable REST APIs
...
<p align="center">
📬 Feel free to explore my repositories, open an issue, or reach out if you want to collaborate on open-source software, full-stack web builds, or mobile apps!
</p>
